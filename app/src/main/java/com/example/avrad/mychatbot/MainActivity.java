package com.example.avrad.mychatbot;
...
import com.example.avrad.mychatbot.Adapter.CustomAdapter;
import com.example.avrad.mychatbot.Helper.HttpDataHandler;
import com.example.avrad.mychatbot.Model.ChatModel;
import com.example.avrad.mychatbot.Model.SimsimiModel;
...
public class MainActivity extends AppCompatActivity {
    ...
    private class SimsimiAPI extends AsyncTask<List<ChatModel> , Void , String> {
        ...
        protected void onPostExecute(String s) {
            ...
            ChatModel chatModel = new ChatModel(response.getResponse(),false);    // to get our response
